...
| 0008 | [Rate-limit policy set, stored in Redis](0008-rate-limit-policy-set-and-redis-storage.md) | accepted |
...
| 0010 | [Synchronous mail, no Messenger in the skeleton](0010-synchronous-mail-no-messenger-in-the-skeleton.md) | accepted |
